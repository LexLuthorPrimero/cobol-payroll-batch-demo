       ...
       AUTHOR. LUCAS-CANETE.
      *====================================================
      * PROGRAMA: Cálculo de Nómina Batch
      * DESCRIPCIÓN: Lee empleados, calcula sueldo neto,
      *              genera reporte y resumen.
      * SIMULA: Procesamiento Batch de Mainframe (JCL)
      *====================================================
       ...
       01  WS-TASA-DESCUENTO   PIC V99 VALUE 0.17.  *> 17% descuento
       ...
       01  CABECERA-2.
           ...
           05  FILLER PIC X(12) VALUE 'SALARIO BRUTO'.
       ...
       PROCEDURE DIVISION.
       MAIN.
      *    Obtener fecha del sistema (simulada con función)
           MOVE FUNCTION CURRENT-DATE(1:10) TO WS-FECHA
           MOVE FUNCTION CURRENT-DATE(12:8) TO WS-HORA
